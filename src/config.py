...
# датасет, но разваливаться в свободном режиме. Значение 0.9 означает: в 10%
# шагов обучения следующая точка берётся из предсказания модели.
teacher_forcing_ratio = 0.9
scheduled_sampling_mode = "argmax"  # "argmax", "mean" или "sample".
